...
module.exports = function (fileName, converter) {
  ...
  function bufferContents(file) {
    ...
    try {
      ...
      data.post[path.basename(file.relative, ".json")] = JSON.parse(file.contents.toString());
      // data['post'] = data[path.basename(file.relative, ".json")];
      // delete data[path.basename(file.relative, ".json")];
